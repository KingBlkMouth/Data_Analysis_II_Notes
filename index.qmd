...
1. git remote set-url origin https://github.com/KingBlkMouth/Data_Analysis_II_Notes.git
2. git remote -v
...
1. git remote add origin https://github.com/KingBlkMouth/Data_Analysis_II_Notes.git
2. git branch -M main
